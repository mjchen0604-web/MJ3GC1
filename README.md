# MJ3GC (CLIProxyAPI Customized)

English | [中文](README_CN.md)

A CLI proxy server based on CLIProxyAPI, with multi-user/API key management panel, quota & concurrency limits, and a user self-service portal.

It supports OpenAI Codex (GPT models) and Claude Code via OAuth.
