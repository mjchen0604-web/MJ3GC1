...
func (s *Server) setupRoutes() {
	...
	v1.Use(AuthMiddleware(s.accessManager), mj3gc.QuotaMiddleware(mj3gc.DefaultStore()))
	{
	...
	v1beta.Use(AuthMiddleware(s.accessManager), mj3gc.QuotaMiddleware(mj3gc.DefaultStore()))
	{
	...
	// Portal endpoints (user self-service)
	portal := s.engine.Group("/v0/portal")
	portal.Use(mj3gc.PortalAuthMiddleware(mj3gc.DefaultStore()))
	{
		portal.GET("/me", s.mgmt.GetMJ3GCPortalMe)
		portal.GET("/usage", s.mgmt.GetMJ3GCPortalUsage)
		portal.GET("/logs", s.mgmt.GetMJ3GCPortalLogs)
	}

	// Root endpoint
	s.engine.GET("/", func(c *gin.Context) {
		c.JSON(http.StatusOK, gin.H{
			"message": "MJ3GC API Server",
			"endpoints": []string{
...
func (s *Server) registerManagementRoutes() {
	...
	{
		mgmt.GET("/mj3gc/state", s.mgmt.GetMJ3GCState)
		mgmt.GET("/mj3gc/users", s.mgmt.GetMJ3GCUsers)
		mgmt.POST("/mj3gc/users", s.mgmt.UpsertMJ3GCUser)
		mgmt.DELETE("/mj3gc/users/:id", s.mgmt.DeleteMJ3GCUser)
		mgmt.GET("/mj3gc/keys", s.mgmt.GetMJ3GCKeys)
		mgmt.POST("/mj3gc/keys", s.mgmt.UpsertMJ3GCKey)
		mgmt.DELETE("/mj3gc/keys/:id", s.mgmt.DeleteMJ3GCKey)
		mgmt.POST("/mj3gc/keys/:id/reset", s.mgmt.ResetMJ3GCKeyUsage)
		mgmt.GET("/mj3gc/usage", s.mgmt.GetMJ3GCUsage)
